...
mean_offset = 0;
% rand_mean = randn(1,300)/sqrt(5);
rand_mean = awgn(.5*cos(4*pi*f0*[1:300]),signal_snr)+mean_offset;
% randn(1,300)/sqrt(5);
...
x(end-300+1:end) = x(end-300 + 1:end) + rand_mean;
change_points = [length(x)-300+1 ];
